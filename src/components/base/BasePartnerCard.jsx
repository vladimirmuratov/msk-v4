...
export const BasePartnerCard = ({alt, logo, label, address, license, imgStyle={}}) => {
    return(
        <Box sx={{
            ...
            <Typography component='h3' sx={{fontSize: {xs: '12px', sm: '14px', md: '16px'}, fontWeight: 500, lineHeight: 1.3, marginBottom: '5px', marginTop: '5px'}}>{label}</Typography>
